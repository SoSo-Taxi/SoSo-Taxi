...
public class UserFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mConstraintLayout1 = root.findViewById(R.id.user_question_callCar_CL);
        mConstraintLayout1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getActivity().getApplicationContext(),HowToCallCarActivity.class));
            }
        });
        return root;
    }
